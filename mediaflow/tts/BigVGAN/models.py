...
import mediaflow.tts.BigVGAN.activations as activations

from mediaflow.tts.BigVGAN.ECAPA_TDNN import ECAPA_TDNN
from mediaflow.tts.BigVGAN.utils import get_padding, init_weights
...
class AMPBlock1(torch.nn.Module):
    def __init__(self, h, channels, kernel_size=3, dilation=(1, 3, 5), activation=None):
        ...
        if self.h.get("use_cuda_kernel", False):
            from mediaflow.tts.BigVGAN.alias_free_activation.cuda.activation1d import Activation1d
        else:
            from mediaflow.tts.BigVGAN.alias_free_torch import Activation1d
