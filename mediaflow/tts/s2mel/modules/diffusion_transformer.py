...
from mediaflow.tts.s2mel.modules.gpt_fast.model import ModelArgs, Transformer
from mediaflow.tts.s2mel.modules.wavenet import WN
from mediaflow.tts.s2mel.modules.commons import sequence_mask
...
class DiT(torch.nn.Module):
    ...
    def forward(self, x, prompt_x, x_lens, t, style, cond, mask_content=False):
        ...
        if class_dropout: #False
            x_in[..., self.in_channels:] = x_in[..., self.in_channels:] * 0 # 80缁村悗鍏ㄧ疆涓?
        ...
        input_pos = self.input_pos[:x_in.size(1)]  # (T,) range锛?锛?863锛?
